...
import com.prasanna.playload.dto.*;
...
//    private static final String KEYCLOAK_BASE_URL = "http://localhost:8080/auth";
    ...
    private static final String CLIENT_SECRET = "SHbTpZOmXm5fmeX45O1ouVPFMf26GJ9rnwusaNWqOydcwsKcpOJd4Yip4iyGQYTfvbXelLtrDg9f80s20Y8gVH"; // Replace with your actual client
    private static final String GRANT_TYPE = "password";
    private static final String scope = "openid profile email";
    private static final String username = "pkkc40";
    private static final String password = "admin";
    private static final String clientId = "3094f2aa-1c67-4f85-858f-b5c3075958ce";
    ...
    public TokenResponse getAdminAccessToken(String username,
        ...
        HttpHeaders headers = new HttpHeaders();
//        headers.setContentType(MediaType.APPLICATION_JSON);
        headers.setContentType(MediaType.APPLICATION_FORM_URLENCODED); //1
...
//        requestBody.add("client_id", clientId);
    ...
    //http://localhost:8080/admin/realms/master/clients/3094f2aa-1c67-4f85-858f-b5c3075958ce/roles/CUSTOMER
    public KeycloakRole getRoleByName(String clientId,
                                      String token,
                                      String role) {

        String url = KEYCLOAK_BASE_URL + "/admin/realms/master/clients/" + clientId + "/roles/" + role; //2
    ...
    //    http://localhost:8080/admin/realms/master/users?username=ravina-3
